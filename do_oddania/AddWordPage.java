...
public class AddWordPage extends javax.swing.JFrame implements Runnable{
    GUIModel model; // połaczenie z modelem
    ...
    public void run() {
        ...
        setVisible(true);
        setResizable(false);
        setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE); // Ukryj po kliknięciu X
    }
    ...
    private void initComponents() {
        ...
        confirmBtn.addActionListener(e -> { // Obsługa guziaka do dodania słowa
